...
active_milestone: "INTEROP Wave A done: reads real external LevelDB DBs read-only. Next: Wave B (build RocksDB)."
last_completed: Wave A LevelDB read-interop (read_only mode, replay-all-logs, Env.listDir)
